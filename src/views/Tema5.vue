...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p.mb-4 Una base de datos necesita desarrollarse en una herramienta específica, puede hacerse de manera elemental en un Excel o utilizar un #[em software] de base de datos. La Base de Datos de Mercadeo (BDM) es la columna vertebral de cualquier sistema de información y más aún en programas de mercadeo uno a uno. Para manejar una base de datos es importante conocer el proceso que lleva a construirla y manejarla.
          ...
          SlyderA(tipo="b").p-4
            ...
            .row.justify-content-center.align-items-center
              .col-lg-7.mb-4.mb-md-0.my-4
                ...
                p(data-aos="zoom-in-rigth") En dicha norma se mencionan algunos indicadores como lo son: fiabilidad, disponibilidad, tiempo medio entre paradas (MTBF, #[em Mid Time Between Failures]), duración de las paradas (MTTR, o #[em Mid Time To Repair]), número de paradas por mantenimiento y tiempo total perdido por mantenimiento.
