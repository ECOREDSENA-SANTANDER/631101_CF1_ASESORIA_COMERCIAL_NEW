      ...
      .col-lg-9.mb-4.mb-lg-0(data-aos="fade-right")
        TabsA.color-primario
          ...
          .tarjeta.color-acento-botones.bg77.p-4(titulo="Accesibles")
            .row.justify-content-center.align-items-center
              .col-lg-12
                p.mb-0(data-aos="fade-right") Los segmentos de mercado pueden ser efectivamente alcanzados y atendidos, estas son las acciones de mercadeo que tenga la empresa hacia el segmento son recibidas y tienen un efecto reactivo.
